...
<div class = "main"> 
<h1 class = "Nom_matiere"> Science Economique et Sociale </h1>
...
<ul class = "sommaire">
    ...
    <ul>
      ...
      <li class ="liens"><a href ="SES/scientifiques_SES.php">Les scientifiques en SES</a></li>
      <li class ="liens"><a href ="SES/le_marche.php">Le marché</a></li>
      <li class ="liens"><a href ="SES/Milieu-social.php">Le milieu social</a></li>
      <li class ="liens"><a href ="SES/Socialisation.php">La socialisation</a></li>
      <li class ="liens"><a href ="SES/production.php">La production</a></li>
      <li class ="liens"><a href ="SES/Le-pouvoir-politique.php">Le pouvoir politique</a></li>
